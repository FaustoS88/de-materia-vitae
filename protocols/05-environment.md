...
Protecting the body from environmental harm. Clean water, UV protection, and air quality.
...
|--------|------|-----------|
| Hippocrates, *On Regimen*, ~400 BC | "Water should be clear, light, odorless, and free from sediment. Boiling and filtering through cloth improves quality." | Book II |
| *Sushruta Samhita*, ~600 BC (Ayurveda) | "Water should be purified by boiling, exposure to sun and copper, or filtering through cloth." | Sutrasthana Chapter 4 |
| Dioscorides, *De Materia Medica*, ~60 AD | "Rain water is the lightest and purest. Spring waters vary in quality according to the minerals they pass through." | Book V, Chapter 8 |
...
- **PFAS ("forever chemicals"):** Bioaccumulate; disrupt endocrine system; reduce immune response; increase cancer risk
- **Heavy metals (lead, arsenic, mercury):** Cumulative neurotoxicity; oxidative stress; DNA damage
- **Chlorine byproducts (THMs):** Formed when chlorine reacts with organic matter; mutagenic and carcinogenic
- **Microplastics:** Emerging evidence of gut microbiome disruption, endocrine disruption

### Protocol

| Filter Type | Removes | Cost | Best For |
|-------------|---------|------|----------|
| **Activated carbon** (Brita-type) | Chlorine, some PFAS, taste/odor | ~$30 + $10/mo filters | Minimum protection |
| **Gravity filter** (Berkey-type) | Bacteria, protozoa, heavy metals, most PFAS | ~$200–400 (one-time) | Good middle ground |
| **Reverse osmosis** | >99% of all contaminants, including heavy metals, fluoride, PFAS, microplastics | ~$200–600 + $50/yr filters | Gold standard |

### Recommendation

- **Minimum:** Quality activated carbon filter
- **Optimal:** Reverse osmosis + remineralization (add back magnesium, calcium that RO removes)
- **If no filter available:** Boil water + let sit (reduces chlorine, some volatile compounds)

### Budget Tiers

| Tier | US Baseline | Notes |
|------|------------|-------|
| **Foundation** | $0 | Boil water, let cool, store in clean container |
| **Essential** | ~$30-40 (one-time) + $10/mo | Activated carbon pitcher filter |
| **Complete** | ~$200-600 (one-time) + $50/yr | Reverse osmosis + remineralization |
...
| Source | Text | Reference |
|--------|------|-----------|
| Avicenna, *Canon of Medicine*, 1025 AD | "Excessive sun exposure damages the skin, causes premature aging, and should be moderated. Protection with oils and coverings is advisable." | Book III |
| Dioscorides, *De Materia Medica*, ~60 AD | "Olive oil applied before sun exposure protects the skin from burning." | Book I, Chapter 35 |
...
- **UV-induced DNA damage:** UVB causes cyclobutane pyrimidine dimers (direct DNA damage → mutations → cancer)
- **Collagen degradation:** UVA activates matrix metalloproteinases (MMPs) that break down collagen and elastin
- **Systemic immunosuppression:** UV radiation suppresses skin immune cells (Langerhans cells), reducing cancer surveillance
- **Oxidative stress:** UV generates reactive oxygen species that damage cellular components throughout the skin

### Protocol

| Parameter | Recommendation |
|-----------|---------------|
| **SPF** | Minimum 30 (blocks 97% UVB); SPF 50 (blocks 98%) |
| **Spectrum** | Broad-spectrum (UVA + UVB) — look for "PA++++" or "broad-spectrum" label |
| **Application** | 2 finger-lengths for face and neck; reapply every 2 hours if outdoors |
| **When** | Every morning, even on cloudy days (UVA penetrates clouds and windows) |
| **Type** | Mineral (zinc oxide, titanium dioxide) = immediate protection; Chemical = needs 15 min to activate |
| **Don't forget** | Ears, back of neck, backs of hands, scalp if thinning hair |
